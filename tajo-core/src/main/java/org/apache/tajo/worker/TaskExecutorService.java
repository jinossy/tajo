...
public class TaskExecutorService<T extends TaskContainer> extends ThreadPoolExecutor {
  ...
  public TaskExecutorService(TajoConf conf) {
    this(conf, conf.getIntVar(ConfVars.WORKER_RESOURCE_AVAILABLE_CPU_CORES));
  }

  public TaskExecutorService(TajoConf conf, int nThreads) {
